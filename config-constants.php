...
function pcdm_render_form() {
	...
	<div class="wrap">
		...
		<div style="margin-top:15px;">
			<p style="margin-bottom:10px;">If you use this FREE Plugin on your website <b><em>please</em></b> consider making a <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=PEDF99Y2ZQE9N" target="_blank">donation</a> to support continued development. Thank you.&nbsp;&nbsp;:)</p>
		</div>
